...
export class XLSX {
    ...
    */
    static new(data) {
        ...
        const ret = wasm.xlsx_new(ptr0, len0);
        return XLSX.__wrap(ret);
    }
    /**
    * @returns {number}
    */
    static with_formulas() {
        const ret = wasm.xlsx_with_formulas();
        return ret >>> 0;
    }
    /**
    * @returns {any}
    */
    get_styles() {
        const ret = wasm.xlsx_get_styles(this.ptr);
    ...
    */
    get_sheet_data(sheet_name, flags) {
        ...
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.xlsx_get_sheet_data(this.ptr, ptr0, len0, flags);
        return takeObject(ret);
    }
}
