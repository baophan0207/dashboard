...
import RoeStructure from "./Animations/roeStructure"
import BuildingApp from './Animations/download_progress.json';
import FileUploadingInProgress from './Animations/FileUploadingInProgress.json';
import TextLoading from './Animations/TextLoading.json';
import ModelCreationInProgress from './Animations/ModelCreationInProgress.json';
import CheckingFiles from './Animations/CheckingFiles.json';
import DataLoad from './Animations/DataLoad.json';
