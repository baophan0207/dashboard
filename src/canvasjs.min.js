...
(function () {
    ...
    var Ja = !1, U = {}, r = !!document.createElement("canvas").getContext, ra = {
            ...
            Crosshair: {
                ...
                labelBorderThickness: 0,
                labelCornerRadius: 0,
                labelFontFamily: r ? "Calibri, Optima, Candara, var(--font-family), Geneva, sans-serif" : "calibri",
                labelFontSize: 12,
                labelFontColor: "#fff",
                labelFontWeight: "normal",
                labelFontStyle: "normal",
    ...
    var X = 20, E = 14, Xa = {
        ...
        legend: {
            fontFamily: v, fontSize: 12, fontColor: fa, fontWeight: "bold", verticalAlign: "bottom",
            horizontalAlign: "center"
        },
        toolTip: {fontFamily: v, fontSize: 12, fontStyle: "normal", cornerRadius: 0, borderThickness: 1}
    };
    Q = fa = "#F5F5F5";
    I = "#FFFFFF";
    ha = "#40BAF1";
    ...
    Na.Chart = function () {
        ...
        $.prototype._initialize = function () {
            if (this.enabled) {
                ...
                a += "font-size: var(--default-title-font-size) !important;";
                a += "color: #000000;";
